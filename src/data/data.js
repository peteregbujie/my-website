export const cards = [
 {
  ...
  description:
   "Full Stack ECommerce store built with NextJS, MongoDB, React Query, Stripe checkout  and Tailwind CSS. Products are prefetched at build time with react query so as to reduce the number of api requests.",
  github: "https://github.com/peteregbujie/nextjs_react_query_ecommerce",
